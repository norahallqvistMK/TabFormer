...
class TabFormerHierarchicalEmbedding(PreTrainedModel):
    base_model_prefix = "bert"
...
class TabFormerBertLM:
    def __init__(self, special_tokens, vocab, field_ce=False, flatten=False, ncols=None, field_hidden_size=768, return_embeddings=False):
    ...
    def get_model(self, field_ce, flatten, return_embeddings):
        if return_embeddings:
            model = TabFormerHierarchicalEmbedding(self.config)
            return model
